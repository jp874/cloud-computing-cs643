...
inputDF = spark.read.csv('s3://practicaltraining/ValidationDataset.csv',header='true', inferSchema='true', sep=';')
...
m=RandomForestModel.load(sc,"s3://practicaltraining/trainingmodel")
